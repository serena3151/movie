...
export default class HomeScreen extends Component {
  ...
  render() {
    ...
    if (movieDetails.poster_link){
      ...
      const {duration,original_title,poster_link,release_date,rating} = movieDetails;
          ...
          >
            ...
            <View style={styles.subContainer}>
              ...
              <View style={styles.iconButtonContainer}>
                ...
                <TouchableOpacity onPress = {this.disliked_movie}>
                  <Image
                    style = {styles.iconImage}
                ...
                <TouchableOpacity onPress = {this.did_not_watch_movie}>
                  <Image
                    style = {styles.iconImage}
